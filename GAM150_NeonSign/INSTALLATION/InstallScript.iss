...
DefaultDirName={pf}\DigiPen\NeonSign

; Start menu directory
DefaultGroupName=DigiPen\NeonSign

; Output directory for the installer.
OutputDir=.\INSTALLER

; Setup executable installer
OutputBaseFilename=NeonSign_Setup
...
Source: .\USERDOCS\*; DestDir: {userdocs}; Flags: ignoreversion recursesubdirs createallsubdirs
...
[Icons]
Name: {group}\NeonSign; Filename: {app}\NeonSign.exe; WorkingDir: {app}; IconFilename: "{app}\Icon.ico"
Name: {group}\{cm:UninstallProgram,NeonSign}; Filename: {uninstallexe}
Name: {commondesktop}\NeonSign; Filename: {app}\NeonSign.exe; Tasks: desktopicon; WorkingDir: {app}; IconFilename: "{app}\Icon.ico"
...
Filename: {app}\NeonSign.exe; Description: {cm:LaunchProgram,NeonSign}; Flags: nowait postinstall skipifsilent
